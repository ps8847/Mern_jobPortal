...
const AdminJobsSetup = () => {
    ...
    useGetJobById(params.id); // Fetch job details based on job ID
    ...
    const selectedCompanyName = companies.find(company => company._id === input.companyId)?.name || "Select a Company";
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                navigate("/admin/jobs"); // Redirect to the job listing page
            }
        } catch (error) {
            console.log(error);
    ...
    // Set the input values when the job details are fetched
    useEffect(() => {
        if (singleJob) {
            setInput({
